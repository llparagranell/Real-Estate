...
import type { TxnHistoryRow } from "./txnHistoryColumns"

interface TxnHistoryDataTableProps<TData, TValue> {
    columns: ColumnDef<TData, TValue>[]
    data: TData[]
}

export function TxnHistoryDataTable<TData extends TxnHistoryRow, TValue>({
    columns,
    data,
}: TxnHistoryDataTableProps<TData, TValue>) {
